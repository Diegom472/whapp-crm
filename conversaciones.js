...
async function bufferAOpusBlob(buffer) {
  ...
  // Asegurar que el contexto esté corriendo (a veces arranca suspendido)
  ...
  return new Promise((resolve) => {
    ...
    try {
      ...
      src.buffer = buffer;
      // Un gain intermedio asegura el ruteo del audio
      ...
      rec.start(sourceNode).then(() => {
        // Pequeño delay para asegurar que el encoder está capturando
        setTimeout(() => {
          src.start(0);
